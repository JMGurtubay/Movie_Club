...
def create_reservation_service(reservation_data: ReservationRequest, user_id:StopAsyncIteration) -> ReservationDB:
    try:
        ...
        print(reservation_data.theater_id)
        print(reservation_data.user_id)
        print(reservation_data.movie_id)
        print("buscar")
        ...
        print("buscando")
        print(reservation_dict["theater_id"])
        print(reservation_dict["user_id"])
        print(reservation_dict["movie_id"])
